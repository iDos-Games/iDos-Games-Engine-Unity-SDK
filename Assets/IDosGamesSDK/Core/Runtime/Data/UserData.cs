...
namespace IDosGames
{
    public class UserData
    {
        ...
        // ---------- Patch: Scheduled Ч increment token balance ----------
        ...
        // ---------- Patch: Scheduled Ч set absolute token balance (after Spend) ----------
        ...
        // ---------- Patch: Scheduled Ч push claimed milestone ----------
        ...
        // ---------- Patch: Scheduled Ч push claimed streak day ----------
        ...
        // ---------- Patch: Chain Ч increment token balance ----------
        ...
        // ---------- Patch: Chain Ч set absolute token balance (after Spend) ----------
        ...
        // ---------- Patch: Chain Ч push claimed milestone ----------
        ...
        // ---------- Patch: Chain Ч push claimed streak day ----------
